...
public class FTPClientUtils {
    private static Logger log = Logger.getLogger(FTPClientUtils.class);
    ...
    public static boolean mkdirs(String remoteDir) throws IOException, FTPClientException {
        ...
        //先访问FTP根目录
        String currentDir = "/";
        FTPClientUtils.getFTPClient().changeWorkingDirectory(currentDir);
        log.info("mkdirs remoteDir===>>> cd rootDir: " + currentDir + "\t result: " + FTPClientUtils.getFTPClient().printWorkingDirectory());
        ...
        for (String dir : dirs) {
            ...
            boolean currentDirWhetherExist = FTPClientUtils.getFTPClient().changeWorkingDirectory(currentDir);
            log.info("mkdirs remoteDir===>>> cd currentDir: " + currentDir + "\tresult: " + currentDirWhetherExist);
            if (!currentDirWhetherExist) {
                boolean makeDirectory = FTPClientUtils.getFTPClient().makeDirectory(dir);
