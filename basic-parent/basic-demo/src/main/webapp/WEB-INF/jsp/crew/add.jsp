...
<div class="modal fade" id="modalBoxByAdd_CrewBean" tabindex="-1" role="dialog" aria-labelledby="modalBoxByAddTitle_CrewBean" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalBoxByAddTitle_CrewBean">Add Task</h4>
            </div>
            <%--模态框 页头header end--%>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" class="form-control" name="clientName" placeholder="Please enter 2 or more characters to find ClientName...." id="modal_Create_Form_Element_clientName">
