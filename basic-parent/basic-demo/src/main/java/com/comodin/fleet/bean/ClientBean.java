...
public class ClientBean implements Serializable {
    ...
    @ValidLength(max = 13, message = "{CLIENT_BEAN_ID_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Id
    ...
    @Length(min = 3, max = 15, message = "{CLIENT_BEAN_INTERNAL_ID_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "client_internal_id")
    private String internalId;

    /**
     * <pre>
     * DB remark: 客户名称{"min":3}
    ...
    @Length(min = 3, max = 100, message = "{CLIENT_BEAN_NAME_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "client_name")
    private String name;

    /**
     * <pre>
     * DB remark: 客户类型【CIT,CLIENT...】{"dataList":["CIT","CLIENT"]}
     * DB column: client_type	VARCHAR(6)	<--->	type	java.lang.String
     * DB is  Nullable: false
     * DB defaultValue: null
     * </pre>
     */
    @ValidAllowData(allowDataArray = {ClientBeanConstant.CLIENT_BEAN_TYPE_CLIENT,ClientBeanConstant.CLIENT_BEAN_TYPE_CIT}, message = "{CLIENT_BEAN_TYPE_ALLOW_DATA}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    ...
    /**
     * <pre>
     * DB remark: 客户所属领域,retailer,bank...{"dataList":["RETAILER","BANK"]}
     * DB column: client_sector	VARCHAR(30)	<--->	sector	java.lang.String
     * DB is  Nullable: true
     * DB defaultValue: null
     * </pre>
     */
    @ValidAllowData(allowDataArray = {ClientBeanConstant.CLIENT_BEAN_SECTOR_BANK,ClientBeanConstant.CLIENT_BEAN_SECTOR_RETAILER}, message = "{CLIENT_BEAN_SECTOR_ALLOW_DATA}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    ...
    /**
     * <pre>
     * DB remark: 逻辑删除标志【N[正常]，Y[删除]】{"dataList":["Y","N"]}
     * DB column: client_delete_flag	CHAR(1)	<--->	deleteFlag	java.lang.String
     * DB is  Nullable: false
     * DB defaultValue: N
     * </pre>
     */
    @ValidAllowData(allowDataArray = {ClientBeanConstant.CLIENT_BEAN_DELETE_FLAG_Y,ClientBeanConstant.CLIENT_BEAN_DELETE_FLAG_N}, message = "{CLIENT_BEAN_DELETE_FLAG_ALLOW_DATA}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * 获取 数据库主键ID{"max":13}
     *
     * @return client_id - 数据库主键ID{"max":13}
     */
    public Long getId() {
        return id;
    }
     ...
     * 获取 客户内部编号{"min":3}
     *
     * @return client_internal_id - 客户内部编号{"min":3}
     */
    ...
    /**
     * 获取 客户类型【CIT,CLIENT...】{"dataList":["CIT","CLIENT"]}
     *
     * @return client_type - 客户类型【CIT,CLIENT...】{"dataList":["CIT","CLIENT"]}
     */
    ...
    /**
     * 设置 客户类型【CIT,CLIENT...】{"dataList":["CIT","CLIENT"]}
     *
     * @param type - 客户类型【CIT,CLIENT...】{"dataList":["CIT","CLIENT"]}
     */
    ...
    /**
     * 获取 客户所属领域,retailer,bank...{"dataList":["RETAILER","BANK"]}
     *
     * @return client_sector - 客户所属领域,retailer,bank...{"dataList":["RETAILER","BANK"]}
     */
    ...
    /**
     * 设置 客户所属领域,retailer,bank...{"dataList":["RETAILER","BANK"]}
     *
     * @param sector - 客户所属领域,retailer,bank...{"dataList":["RETAILER","BANK"]}
     */
    ...
    /**
     * 获取 逻辑删除标志【N[正常]，Y[删除]】{"dataList":["Y","N"]}
     *
     * @return client_delete_flag - 逻辑删除标志【N[正常]，Y[删除]】{"dataList":["Y","N"]}
     */
    ...
    /**
     * 设置 逻辑删除标志【N[正常]，Y[删除]】{"dataList":["Y","N"]}
     *
     * @param deleteFlag - 逻辑删除标志【N[正常]，Y[删除]】{"dataList":["Y","N"]}
     */
