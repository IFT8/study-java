...
import com.comodin.fleet.constants.i18n.UserBeanI18nConstant;
...
public class UserBean implements Serializable {
     ...
     * <pre>
     * DB remark: 姓名,名
     * DB column: user_first_name	VARCHAR(100)	<--->	firstName	java.lang.String
     * DB is  Nullable: true
     * DB defaultValue: null
     * </pre>
     */
    @Length(max = 100, message = "{" + UserBeanI18nConstant.USER_BEAN_FIRST_NAME_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * <pre>
     * DB remark: 姓名,姓
     * DB column: user_last_name	VARCHAR(100)	<--->	lastName	java.lang.String
     * DB is  Nullable: true
     * DB defaultValue: null
     * </pre>
     */
    @Length(max = 100, message = "{" + UserBeanI18nConstant.USER_BEAN_LAST_NAME_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "user_last_name", length = 100, nullable = true)
