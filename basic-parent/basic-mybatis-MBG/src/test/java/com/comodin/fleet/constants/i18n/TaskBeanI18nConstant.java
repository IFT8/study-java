...
public class TaskBeanI18nConstant  {
    ...
    /**
     * 任务类型为客户到客户，特殊字段标识，是否跳过收钱阶段【N[正常的客户到客户类型，先完成收钱阶段，才能处理送钱阶段],Y[跳过收钱阶段，直接操作送钱阶段]】
     */
    public static final String TASK_BEAN_CLIENT_TO_CLIENT_SKIP_PICKUP_LENGTH = "TASK_BEAN_CLIENT_TO_CLIENT_SKIP_PICKUP_LENGTH";
    /**
     * 创建时间
     */
