...
public class BankAtmCodeBeanI18nConstant  {
     ...
     * 数据库主键ID
     */
    public static final String BANK_ATM_CODE_BEAN_ID_LENGTH = "BANK_ATM_CODE_BEAN_ID_LENGTH";
    /**
     * 状态码描述
     */
     ...
     * 数据库主键ID
     */
    public static final String BANK_ATM_CODE_BEAN_ID_NOT_NULL = "BANK_ATM_CODE_BEAN_ID_NOT_NULL";
    /**
     * 出错状态码
     */
     ...
     * 状态码出现时建议内容
     */
    public static final String BANK_ATM_CODE_BEAN_SUGGESTION_LENGTH = "BANK_ATM_CODE_BEAN_SUGGESTION_LENGTH";
    /**
     * 出错状态码
     */
