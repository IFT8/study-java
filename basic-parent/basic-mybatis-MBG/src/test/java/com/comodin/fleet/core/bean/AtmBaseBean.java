...
public class AtmBaseBean implements Serializable {
    ...
    /**
     * <pre>
     * DB remark: ATM被操作时的状态
     * DB column: base_handle_status	CHAR(32)	<--->	handleStatus	java.lang.String
     * DB is  Nullable: true
     * DB defaultValue: null
     * </pre>
     */
    @Length(max = 32, message = "{" + AtmBaseBeanI18nConstant.ATM_BASE_BEAN_HANDLE_STATUS_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "base_handle_status", length = 32, nullable = true)
     ...
     * <pre>
     * DB remark: 最新心跳包时间
     * DB column: base_live_timestamp	BIGINT(19)	<--->	liveTimestamp	java.lang.Long
     * DB is  Nullable: true
     * DB defaultValue: 0
     * </pre>
     */
    @ValidLength(max = 19, message = "{" + AtmBaseBeanI18nConstant.ATM_BASE_BEAN_LIVE_TIMESTAMP_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "base_live_timestamp", length = 19, nullable = true)
     ...
     * 获取 ATM被操作时的状态
     *
     * @return base_handle_status - ATM被操作时的状态
     */
     ...
     * 设置 ATM被操作时的状态
     *
     * @param handleStatus - ATM被操作时的状态
     */
    public AtmBaseBean setHandleStatus(String handleStatus) {
     ...
     * 获取 最新心跳包时间
     *
     * @return base_live_timestamp - 最新心跳包时间
     */
     ...
     * 设置 最新心跳包时间
     *
     * @param liveTimestamp - 最新心跳包时间
     */
    public AtmBaseBean setLiveTimestamp(Long liveTimestamp) {
