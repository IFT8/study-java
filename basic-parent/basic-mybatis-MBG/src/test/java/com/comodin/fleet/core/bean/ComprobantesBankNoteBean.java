...
public class ComprobantesBankNoteBean implements Serializable {
     ...
     * </pre>
     */
    @NotNull(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_ID_NOT_NULL + "}", groups = {IBaseValidGroup.Update.class})
    @ValidLength(max = 20, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_ID_LENGTH + "}", groups = {IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_COMPROBANTES_CODE_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 15, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_COMPROBANTES_CODE_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_BANK_NOTE_TYPE_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 5, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_BANK_NOTE_TYPE_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotNull(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_NUMBER_NOT_NULL + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @ValidLength(max = 10, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_NUMBER_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_STATUS_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 7, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_STATUS_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @ValidDateTimeFormat(pattern = DateUtil.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_CREATE_TIMESTAMP_DATE_TIME_FORMAT + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @DateTimeFormat(pattern = DateUtil.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS)
    @NotNull(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_CREATE_TIMESTAMP_NOT_NULL + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_CREATE_BY_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_CREATE_BY_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_DELETE_FLAG_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 1, message = "{" + ComprobantesBankNoteBeanI18nConstant.COMPROBANTES_BANK_NOTE_BEAN_DELETE_FLAG_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
