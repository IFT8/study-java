...
public class SioLoginAccount implements Serializable {
    /**
     * <pre>
     * DB remark: 数据库主键ID
     ...
     * </pre>
     */
    @NotNull(message = "{SIO_LOGIN_ACCOUNT_ID_NOT_NULL}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @ValidLength(max = 20, message = "{SIO_LOGIN_ACCOUNT_ID_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Id
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_COMPANY_INTERNAL_ID_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 15, message = "{SIO_LOGIN_ACCOUNT_COMPANY_INTERNAL_ID_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_company_internal_id")
     ...
     * </pre>
     */
    @Length(max = 50, message = "{SIO_LOGIN_ACCOUNT_COMPANY_NAME_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 15, message = "{SIO_LOGIN_ACCOUNT_BRANCH_INTERNAL_ID_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_branch_internal_id")
     ...
     * </pre>
     */
    @Length(max = 15, message = "{SIO_LOGIN_ACCOUNT_BRANCH_NAME_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_USERNAME_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_USERNAME_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_PASSWORD_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_LOGIN_URL_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 100, message = "{SIO_LOGIN_ACCOUNT_LOGIN_URL_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_login_url")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_COMPANY_INTERNAL_ID_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_COMPANY_INTERNAL_ID_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_key_login_company_internal_id")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_BRANCH_INTERNAL_ID_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_BRANCH_INTERNAL_ID_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_key_login_branch_internal_id")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_USERNAME_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_USERNAME_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_key_login_username")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_PASSWORD_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_KEY_LOGIN_PASSWORD_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_key_login_password")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_UPLOAD_DATA_URL_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 100, message = "{SIO_LOGIN_ACCOUNT_UPLOAD_DATA_URL_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_upload_data_url")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_KEY_UPLOAD_DATA_FILE_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_KEY_UPLOAD_DATA_FILE_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_key_upload_data_file")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_KEY_UPLOAD_DATA_TOKEN_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_KEY_UPLOAD_DATA_TOKEN_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_key_upload_data_token")
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_STATUS_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 7, message = "{SIO_LOGIN_ACCOUNT_STATUS_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @ValidDateTimeFormat(pattern = DateUtil.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS , message = "{SIO_LOGIN_ACCOUNT_CREATE_TIMESTAMP_DATE_TIME_FORMAT}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @DateTimeFormat(pattern = DateUtil.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS)
    @NotNull(message = "{SIO_LOGIN_ACCOUNT_CREATE_TIMESTAMP_NOT_NULL}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_CREATE_BY_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{SIO_LOGIN_ACCOUNT_CREATE_BY_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{SIO_LOGIN_ACCOUNT_DELETE_FLAG_NOT_BLANK}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 1, message = "{SIO_LOGIN_ACCOUNT_DELETE_FLAG_LENGTH}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "account_delete_flag")
     ...
     * @param id - 数据库主键ID
     */
    public SioLoginAccount setId(Long id) {
        this.id = id;
        return this;
    }
     ...
     */
    public SioLoginAccount setCompanyInternalId(String companyInternalId) {
     ...
     */
    public SioLoginAccount setCompanyName(String companyName) {
     ...
     */
    public SioLoginAccount setBranchInternalId(String branchInternalId) {
     ...
     */
    public SioLoginAccount setBranchName(String branchName) {
     ...
     */
    public SioLoginAccount setUsername(String username) {
     ...
     */
    public SioLoginAccount setPassword(String password) {
     ...
     */
    public SioLoginAccount setLoginUrl(String loginUrl) {
     ...
     */
    public SioLoginAccount setKeyLoginCompanyInternalId(String keyLoginCompanyInternalId) {
     ...
     */
    public SioLoginAccount setKeyLoginBranchInternalId(String keyLoginBranchInternalId) {
     ...
     */
    public SioLoginAccount setKeyLoginUsername(String keyLoginUsername) {
     ...
     */
    public SioLoginAccount setKeyLoginPassword(String keyLoginPassword) {
     ...
     */
    public SioLoginAccount setUploadDataUrl(String uploadDataUrl) {
     ...
     */
    public SioLoginAccount setKeyUploadDataFile(String keyUploadDataFile) {
     ...
     */
    public SioLoginAccount setKeyUploadDataToken(String keyUploadDataToken) {
     ...
     */
    public SioLoginAccount setStatus(String status) {
     ...
     */
    public SioLoginAccount setCreateTimestamp(Date createTimestamp) {
     ...
     */
    public SioLoginAccount setCreateBy(String createBy) {
     ...
     */
    public SioLoginAccount setDeleteFlag(String deleteFlag) {
