...
import com.comodin.fleet.constants.i18n.VehicleBeanI18nConstant;
...
public class VehicleBean implements Serializable {
     ...
     * </pre>
     */
    @NotNull(message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_ID_NOT_NULL + "}", groups = {IBaseValidGroup.Update.class})
    @ValidLength(max = 20, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_ID_LENGTH + "}", groups = {IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 15, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_INTERNAL_ID_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 15, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_TOMTOM_ID_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotNull(message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_BRANCH_ID_NOT_NULL + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @ValidLength(max = 20, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_BRANCH_ID_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 20, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_LICENSE_PLATE_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 30, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_VIN_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @ValidLength(max = 10, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_NUCLEAR_LOAD_PEOPLE_NUMBER_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 4, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_YEAR_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 15, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_CURRENCY_CAPACITY_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 80, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_DESCRIPTION_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 30, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_MODEL_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 30, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_SERVICE_TYPE_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_ARMORED_LEVEL_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_ARMORED_LEVEL_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_STATUS_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 15, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_STATUS_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 15, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_MILEAGE_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @ValidDateTimeFormat(pattern = DateUtil.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_LAST_MAINTENANCE_TIME_DATE_TIME_FORMAT + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 20, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_PRINCIPAL_BY_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @Length(max = 20, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_OPERATOR_BY_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @ValidDateTimeFormat(pattern = DateUtil.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_CREATE_TIMESTAMP_DATE_TIME_FORMAT + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @DateTimeFormat(pattern = DateUtil.DATE_PATTERN_YYYY_MM_DD_HH_MM_SS)
    @NotNull(message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_CREATE_TIMESTAMP_NOT_NULL + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_CREATE_BY_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 20, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_CREATE_BY_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * </pre>
     */
    @NotBlank(message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_DELETE_FLAG_NOT_BLANK + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Length(max = 1, message = "{" + VehicleBeanI18nConstant.VEHICLE_BEAN_DELETE_FLAG_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
