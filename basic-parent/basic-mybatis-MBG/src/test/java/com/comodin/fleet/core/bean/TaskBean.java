...
import com.comodin.fleet.constants.i18n.TaskBeanI18nConstant;
...
public class TaskBean implements Serializable {
    ...
    /**
     * <pre>
     * DB remark: 任务类型为客户到客户，特殊字段标识，是否跳过收钱阶段【N[正常的客户到客户类型，先完成收钱阶段，才能处理送钱阶段],Y[跳过收钱阶段，直接操作送钱阶段]】
     * DB column: task_client_to_client_skip_pickup	CHAR(1)	<--->	clientToClientSkipPickup	java.lang.String
     * DB is  Nullable: true
     * DB defaultValue: N
     * </pre>
     */
    @Length(max = 1, message = "{" + TaskBeanI18nConstant.TASK_BEAN_CLIENT_TO_CLIENT_SKIP_PICKUP_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
    @Column(name = "task_client_to_client_skip_pickup", length = 1, nullable = true)
    private String clientToClientSkipPickup;
    ...
    /**
     * 获取 任务类型为客户到客户，特殊字段标识，是否跳过收钱阶段【N[正常的客户到客户类型，先完成收钱阶段，才能处理送钱阶段],Y[跳过收钱阶段，直接操作送钱阶段]】
     *
     * @return task_client_to_client_skip_pickup - 任务类型为客户到客户，特殊字段标识，是否跳过收钱阶段【N[正常的客户到客户类型，先完成收钱阶段，才能处理送钱阶段],Y[跳过收钱阶段，直接操作送钱阶段]】
     */
    public String getClientToClientSkipPickup() {
        return clientToClientSkipPickup;
    }

    /**
     * 设置 任务类型为客户到客户，特殊字段标识，是否跳过收钱阶段【N[正常的客户到客户类型，先完成收钱阶段，才能处理送钱阶段],Y[跳过收钱阶段，直接操作送钱阶段]】
     *
     * @param clientToClientSkipPickup - 任务类型为客户到客户，特殊字段标识，是否跳过收钱阶段【N[正常的客户到客户类型，先完成收钱阶段，才能处理送钱阶段],Y[跳过收钱阶段，直接操作送钱阶段]】
     */
    public TaskBean setClientToClientSkipPickup(String clientToClientSkipPickup) {
        this.clientToClientSkipPickup = clientToClientSkipPickup == null ? null : clientToClientSkipPickup.trim();
        return this;
    }
}