...
import com.comodin.fleet.constant.i18n.CrewBeanI18nConstant;
...
public class CrewBean implements Serializable {
     ...
     * <pre>
     * DB remark: 姓名,名
     * DB column: crew_first_name	VARCHAR(50)	<--->	firstName	java.lang.String
     * DB is  Nullable: false
     * DB defaultValue: null
     * </pre>
     */
    ...
    @Length(max = 50, message = "{" + CrewBeanI18nConstant.CREW_BEAN_FIRST_NAME_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
     ...
     * <pre>
     * DB remark: 姓名,姓
     * DB column: crew_last_name	VARCHAR(50)	<--->	lastName	java.lang.String
     * DB is  Nullable: false
     * DB defaultValue: null
     * </pre>
     */
    ...
    @Length(max = 50, message = "{" + CrewBeanI18nConstant.CREW_BEAN_LAST_NAME_LENGTH + "}", groups = {IBaseValidGroup.Add.class, IBaseValidGroup.Update.class})
